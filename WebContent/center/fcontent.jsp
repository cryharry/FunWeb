	...
	<table id="notice">
		...
		<% if(boardBean.getFile() != null){ %>
			...
			<td colspan="3">
				...
				<a href="file_down.jsp?file_name=<%=boardBean.getFile() %>">[Download]</a>
			</td>
		<% } %>
		</tr>
		<tr>
			<td>글내용</td>
			<td colspan="3"><%=boardBean.getContent() %><% if(boardBean.getFile() != null){ %><img src="../upload/<%=boardBean.getFile()%>"><%} %></td>
		</tr>
	</table>
	<div id="table_search">
	<%
		...
		%>
			...
			<input type="button" value="글삭제" class="btn" onclick="location.href='fdelete.jsp'">
